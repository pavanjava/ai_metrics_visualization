...
export const BiomedicalRagScores4 = () => {
    const data = [
        { questionId: 1, ansRel: 1.00, ctxRel: 0.09 },
        { questionId: 2, ansRel: 0.50, ctxRel: 0.10 },
        { questionId: 3, ansRel: 0.64, ctxRel: 0.03 },
        { questionId: 4, ansRel: 1.00, ctxRel: 0.01 },
        { questionId: 5, ansRel: 0.23, ctxRel: 0.26 },
        { questionId: 6, ansRel: 1.00, ctxRel: 0.06 },
        { questionId: 7, ansRel: 0.94, ctxRel: 0.09 },
        { questionId: 8, ansRel: 1.00, ctxRel: 0.04 },
        { questionId: 9, ansRel: 0.75, ctxRel: 0.05 }
    ];
    ...
    return (
        <div className="w-full p-4">
            ...
            <h4 className="text-sm mb-6 text-center">(chunk size: 512, chunk overlap: 100, embedding: sentence-transformers/all-MiniLM-L6-v2)</h4>
