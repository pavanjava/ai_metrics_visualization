...
export const BiomedicalRagScores5 = () => {
    const data = [
        { questionId: 1, ansRel: 0.89, ctxRel: 0.20 },
        { questionId: 2, ansRel: 0.69, ctxRel: 0.13 },
        { questionId: 3, ansRel: 0.73, ctxRel: 0.03 },
        { questionId: 4, ansRel: 0.78, ctxRel: 0.06 },
        { questionId: 5, ansRel: 1.00, ctxRel: 0.31 },
        { questionId: 6, ansRel: 0.73, ctxRel: 0.20 },
        { questionId: 7, ansRel: 0.60, ctxRel: 0.15 },
        { questionId: 8, ansRel: 1.00, ctxRel: 0.14 },
        { questionId: 9, ansRel: 1.00, ctxRel: 0.11 },
        { questionId: 10, ansRel: 1.00, ctxRel: 0.15 }
    ];
    ...
    return (
        <div className="w-full p-4">
            ...
            <h4 className="text-sm mb-6 text-center">(chunk size: 128, chunk overlap: 50, embedding: pavanmantha/bge-base-en-bioembed)</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                    ...
                    <ul className="list-disc pl-5">
                        <li>High answer relevancy despite very low context relevancy across all questions</li>
                        <li>Questions 4, 7, 8, and 9 have perfect answer relevancy scores (1.00)</li>
                        <li>Question 6 has the lowest answer relevancy (0.60)</li>
                        <li>Question 4 has the highest context relevancy (0.31)</li>
                        <li>All context relevancy scores remain below 0.32, indicating poor retrieval quality</li>
                        <li>Question 2 has the lowest context relevancy (0.03)</li>
                        <li>The average answer relevancy (0.84) is much higher than average context relevancy (0.15)</li>
                        <li>The model provides highly relevant answers despite working with largely irrelevant context</li>
                    </ul>
                </div>
            </div>
        </div>
