...
export const BiomedicalRagScores1 = () => {
    const data = [
        { questionId: 1, ansRel: 1.00, ctxRel: 0.24 },
        { questionId: 2, ansRel: 0.80, ctxRel: 0.16 },
        { questionId: 3, ansRel: 0.78, ctxRel: 0.05 },
        { questionId: 4, ansRel: 0.83, ctxRel: 0.09 },
        { questionId: 5, ansRel: 0.67, ctxRel: 0.32 },
        { questionId: 6, ansRel: 0.96, ctxRel: 0.18 },
        { questionId: 7, ansRel: 0.58, ctxRel: 0.16 },
        { questionId: 8, ansRel: 1.00, ctxRel: 0.21 },
        { questionId: 9, ansRel: 0.67, ctxRel: 0.23 },
        { questionId: 10, ansRel: 1.00, ctxRel: 0.31 }
    ];
    ...
    return (
        <div className="w-full p-4">
            ...
            <h4 className="text-sm mb-6 text-center">(chunk size: 128, chunk overlap: 50, embedding: pavanmantha/distilroberta-pubmed-embeddings)</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                    ...
                    <ul className="list-disc pl-5">
                        <li>High answer relevancy despite low context relevancy</li>
                        <li>Questions 1, 8, and 10 have perfect answer relevancy scores</li>
                        <li>Question 7 has the lowest answer relevancy (0.58)</li>
                        <li>Question 5 has the highest context relevancy (0.32)</li>
                    </ul>
                </div>
            </div>
        </div>
