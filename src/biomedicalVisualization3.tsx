...
export const BiomedicalRagScores3 = () => {
    const data = [
        { questionId: 1, ansRel: 1.00, ctxRel: 0.24 },
        { questionId: 2, ansRel: 1.00, ctxRel: 0.25 },
        { questionId: 3, ansRel: 0.57, ctxRel: 0.07 },
        { questionId: 4, ansRel: 0.75, ctxRel: 0.07 },
        { questionId: 5, ansRel: 0.87, ctxRel: 0.34 },
        { questionId: 6, ansRel: 0.56, ctxRel: 0.14 },
        { questionId: 7, ansRel: 0.78, ctxRel: 0.21 },
        { questionId: 8, ansRel: 1.00, ctxRel: 0.13 },
        { questionId: 9, ansRel: 0.80, ctxRel: 0.22 },
        { questionId: 10, ansRel: 0.75, ctxRel: 0.19 }
    ];
    ...
    return (
        <div className="w-full p-4">
            ...
            <h4 className="text-sm mb-6 text-center">(chunk size: 128, chunk overlap: 50, embedding: sentence-transformers/all-MiniLM-L6-v2)</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                    ...
                    <ul className="list-disc pl-5">
                        <li>High answer relevancy despite consistently low context relevancy</li>
                        <li>Questions 1, 2, and 8 have perfect answer relevancy scores (1.00)</li>
                        <li>Question 6 has the lowest answer relevancy (0.56)</li>
                        <li>Question 5 has the highest context relevancy (0.34)</li>
                        <li>There's a notable gap between answer quality and context relevancy across all questions</li>
                    </ul>
                </div>
            </div>
        </div>
